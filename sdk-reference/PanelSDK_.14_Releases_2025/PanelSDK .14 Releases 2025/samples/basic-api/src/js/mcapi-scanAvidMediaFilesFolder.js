...
Avid MediaFiles folder to scan and create clips: <br />\
<input type="text" id="scanAvidMediaFilesFolder-input" placeholder="Media Folder Path" ></input> \
<br /> \
<input type="text" id="mediaFile1-input" placeholder="Media File Name" ></input> \
<br /> \
<input type="text" id="mediaFile2-input" placeholder="Media File Name" ></input> \
<br /> \
Bin Path: <br />\
