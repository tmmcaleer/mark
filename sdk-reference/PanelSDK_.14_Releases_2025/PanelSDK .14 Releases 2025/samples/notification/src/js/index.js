...
function onActiveMonitorChanged(mobID, viewerType, pos) {
    addTextNode(`Active Monitor Changed: Viewer: ${viewerType}, MobID: ${mobID}, Position: ${pos}`);
}
    ...
    mcapi.onEvent.connect(function (eventName, eventData) {
        switch (eventName) {
            ...
            case "DonePlayingEvent":
                ...
                break;
            case "ActiveMonitorChangedEvent":
                {
                    const jsonData = JSON.parse(eventData);
                    onActiveMonitorChanged(jsonData.mobId, jsonData.viewerType, jsonData.pos);
                }  
                break;
