...
import { load_getListOfWindows } from "./mcapi-getListOfWindows.js";
import { load_getListOfSequenceTemplates } from "./mcapi-getListOfSequenceTemplates.js";
import { load_makeActiveWindow } from "./mcapi-makeActiveWindow.js";
import { load_makeViewerActive } from "./mcapi-makeViewerActive.js";
import { load_showWindow  } from "./mcapi-showWindow.js";
...
export const DATA = {
    apis: [
        ...
        {
            name: "getListOfSequenceTemplates",
            loadContent: function () { return load_getListOfSequenceTemplates(); }
        },
        {
        ...
        {
            name: "getListOfWindows",
            loadContent: function () { return load_getListOfWindows(); }
        },
        {
            name: "makeActiveWindow",
            loadContent: function () { return load_makeActiveWindow(); }
        },
        {
            name: "makeViewerActive",
            loadContent: function () { return load_makeViewerActive(); }
        },
        {
            name: "showWindow",
            loadContent: function () { return load_showWindow(); }
        },
    ]
};
