...
- [MCAPI_Types.proto](#MCAPI_Types-proto)
    ...
    - [GetListOfSequenceTemplatesRequest](#mcapi-GetListOfSequenceTemplatesRequest)
    - [GetListOfSequenceTemplatesRequestBody](#mcapi-GetListOfSequenceTemplatesRequestBody)
    - [GetListOfSequenceTemplatesResponse](#mcapi-GetListOfSequenceTemplatesResponse)
    - [GetListOfSequenceTemplatesResponseBody](#mcapi-GetListOfSequenceTemplatesResponseBody)
    - [GetListOfWindowsRequest](#mcapi-GetListOfWindowsRequest)
    - [GetListOfWindowsRequestBody](#mcapi-GetListOfWindowsRequestBody)
    - [GetListOfWindowsResponse](#mcapi-GetListOfWindowsResponse)
    - [GetListOfWindowsResponseBody](#mcapi-GetListOfWindowsResponseBody)
    - [GetListOfWindowsResponseBody.WindowInfo](#mcapi-GetListOfWindowsResponseBody-WindowInfo)
    ...
    - [MakeActiveWindowRequest](#mcapi-MakeActiveWindowRequest)
    - [MakeActiveWindowRequestBody](#mcapi-MakeActiveWindowRequestBody)
    - [MakeActiveWindowResponse](#mcapi-MakeActiveWindowResponse)
    - [MakeActiveWindowResponseBody](#mcapi-MakeActiveWindowResponseBody)
    - [MakeViewerActiveRequest](#mcapi-MakeViewerActiveRequest)
    - [MakeViewerActiveRequestBody](#mcapi-MakeViewerActiveRequestBody)
    - [MakeViewerActiveResponse](#mcapi-MakeViewerActiveResponse)
    - [MakeViewerActiveResponseBody](#mcapi-MakeViewerActiveResponseBody)
    ...
    - [SetPositionRequest](#mcapi-SetPositionRequest)
    - [SetPositionRequestBody](#mcapi-SetPositionRequestBody)
    - [SetPositionResponse](#mcapi-SetPositionResponse)
    - [SetPositionResponseBody](#mcapi-SetPositionResponseBody)
    - [ShowWindowRequest](#mcapi-ShowWindowRequest)
    - [ShowWindowRequestBody](#mcapi-ShowWindowRequestBody)
    - [ShowWindowResponse](#mcapi-ShowWindowResponse)
    - [ShowWindowResponseBody](#mcapi-ShowWindowResponseBody)
    ...
    - [GetListOfWindowsRequestBody.WindowsFilter](#mcapi-GetListOfWindowsRequestBody-WindowsFilter)
...
| SetPosition | [SetPositionRequest](#mcapi-SetPositionRequest) | [SetPositionResponse](#mcapi-SetPositionResponse) | Sets Position for the given mobID, frame offset or timecode. The mobID, if provided, must be loaded in the active monitor. If the mobID is not provided, then the active monitor will have position changed at the given offset (>= 0) or given timecode. |
| GetListOfWindows | [GetListOfWindowsRequest](#mcapi-GetListOfWindowsRequest) | [GetListOfWindowsResponse](#mcapi-GetListOfWindowsResponse) | Will return the current list of all windows, with criteria by type and visibility. |
| GetListOfSequenceTemplates | [GetListOfSequenceTemplatesRequest](#mcapi-GetListOfSequenceTemplatesRequest) | [GetListOfSequenceTemplatesResponse](#mcapi-GetListOfSequenceTemplatesResponse) | Returns the currently available list of Sequence Templates names, with additional information about with is currently set as default. |
| MakeActiveWindow | [MakeActiveWindowRequest](#mcapi-MakeActiveWindowRequest) | [MakeActiveWindowResponse](#mcapi-MakeActiveWindowResponse) | Make active window using unique id returned from previous call to GetListOfWindows. |
| MakeViewerActive | [MakeViewerActiveRequest](#mcapi-MakeViewerActiveRequest) | [MakeViewerActiveResponse](#mcapi-MakeViewerActiveResponse) | Make a specific viewer(monitor) active to control loaded mobs. |
| ShowWindow | [ShowWindowRequest](#mcapi-ShowWindowRequest) | [ShowWindowResponse](#mcapi-ShowWindowResponse) | Show window which is hidden/minimized using unique id returned from previous call to GetListOfWindows. |
...
<a name="mcapi-GetListOfSequenceTemplatesRequest"></a>

### GetListOfSequenceTemplatesRequest
The request of GetListOfSequenceTemplates


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request Header |
| body | [GetListOfSequenceTemplatesRequestBody](#mcapi-GetListOfSequenceTemplatesRequestBody) |  | Request Body |
...
<a name="mcapi-GetListOfSequenceTemplatesRequestBody"></a>

### GetListOfSequenceTemplatesRequestBody
The body of GetListOfSequenceTemplatesRequest
...
<a name="mcapi-GetListOfSequenceTemplatesResponse"></a>

### GetListOfSequenceTemplatesResponse
The response of GetListOfSequenceTemplates


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Response Header |
| body | [GetListOfSequenceTemplatesResponseBody](#mcapi-GetListOfSequenceTemplatesResponseBody) |  | Response body |
...
<a name="mcapi-GetListOfSequenceTemplatesResponseBody"></a>

### GetListOfSequenceTemplatesResponseBody
The body of GetListOfSequenceTemplatesResponse


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| setting_names | [string](#string) | repeated | sequence template name |
| active_setting | [string](#string) |  | currently active sequence template name |
...
<a name="mcapi-GetListOfWindowsRequest"></a>

### GetListOfWindowsRequest
The request of GetListOfWindows()


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request header |
| body | [GetListOfWindowsRequestBody](#mcapi-GetListOfWindowsRequestBody) |  | Request body |
...
<a name="mcapi-GetListOfWindowsRequestBody"></a>

### GetListOfWindowsRequestBody
The body of GetListOfWindowsRequest


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| windows_filter | [GetListOfWindowsRequestBody.WindowsFilter](#mcapi-GetListOfWindowsRequestBody-WindowsFilter) |  |  |
| windows_type | [string](#string) |  |  |
...
<a name="mcapi-GetListOfWindowsResponse"></a>

### GetListOfWindowsResponse
The response of GetListOfWindows


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Response header |
| body | [GetListOfWindowsResponseBody](#mcapi-GetListOfWindowsResponseBody) |  | Response body |
...
<a name="mcapi-GetListOfWindowsResponseBody"></a>

### GetListOfWindowsResponseBody
The body of GetListOfWindowsResponse


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| windows | [GetListOfWindowsResponseBody.WindowInfo](#mcapi-GetListOfWindowsResponseBody-WindowInfo) | repeated | The list of Avid Windows |
...
<a name="mcapi-GetListOfWindowsResponseBody-WindowInfo"></a>

### GetListOfWindowsResponseBody.WindowInfo
Represents Avid Window info.


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| id | [string](#string) |  | window id |
| name | [string](#string) |  | window name |
| type | [string](#string) |  | window type (including Tool window, Bin Container, Bin window, Script window, Panel SDK window) |
| visibility | [bool](#bool) |  | window visible or hidden |
| instanceType | [bool](#bool) |  | single instance or multi instance |
| active | [bool](#bool) |  | window active or inactive |
...
<a name="mcapi-MakeActiveWindowRequest"></a>

### MakeActiveWindowRequest
The request of MakeActiveWindow()


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request header |
| body | [MakeActiveWindowRequestBody](#mcapi-MakeActiveWindowRequestBody) |  | Request body |
...
<a name="mcapi-MakeActiveWindowRequestBody"></a>

### MakeActiveWindowRequestBody
The body of MakeActiveWindowRequest
...
<a name="mcapi-MakeActiveWindowResponse"></a>

### MakeActiveWindowResponse
The response of MakeActiveWindow


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Response header |
| body | [MakeActiveWindowResponseBody](#mcapi-MakeActiveWindowResponseBody) |  | Response body |
...
<a name="mcapi-MakeActiveWindowResponseBody"></a>

### MakeActiveWindowResponseBody
The body of MakeActiveWindowResponse
...
<a name="mcapi-MakeViewerActiveRequest"></a>

### MakeViewerActiveRequest
The request of MakeViewerActive


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request header |
| body | [MakeViewerActiveRequestBody](#mcapi-MakeViewerActiveRequestBody) |  | Request body |
...
<a name="mcapi-MakeViewerActiveRequestBody"></a>

### MakeViewerActiveRequestBody
The body of MakeViewerActiveRequest


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| type | [ViewerType](#mcapi-ViewerType) |  | Viewer type, source/record/Popup/Center |
| mob_id | [string](#string) |  | Mob ID to look for |
...
<a name="mcapi-MakeViewerActiveResponse"></a>

### MakeViewerActiveResponse
The response of MakeViewerActive


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Response header |
| body | [MakeViewerActiveResponseBody](#mcapi-MakeViewerActiveResponseBody) |  | Response body |
...
<a name="mcapi-MakeViewerActiveResponseBody"></a>

### MakeViewerActiveResponseBody
The body of MakeActiveViewerResponse
...
<a name="mcapi-SetPositionRequest"></a>

### SetPositionRequest
The request of SetPosition


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request header |
| body | [SetPositionRequestBody](#mcapi-SetPositionRequestBody) |  | Request body |
...
<a name="mcapi-SetPositionRequestBody"></a>

### SetPositionRequestBody
The body of SetPositionRequest
...
<a name="mcapi-SetPositionResponse"></a>

### SetPositionResponse
The response of SetPosition


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Request header |
| body | [SetPositionResponseBody](#mcapi-SetPositionResponseBody) |  | Request body |
...
<a name="mcapi-SetPositionResponseBody"></a>

### SetPositionResponseBody
The body of SetPositionResponse
...
<a name="mcapi-ShowWindowRequest"></a>

### ShowWindowRequest
The request of ShowWindow()


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [RequestHeader](#mcapi-RequestHeader) |  | Request header |
| body | [ShowWindowRequestBody](#mcapi-ShowWindowRequestBody) |  | Request body |
...
<a name="mcapi-ShowWindowRequestBody"></a>

### ShowWindowRequestBody
The body of ShowWindowRequest
...
<a name="mcapi-ShowWindowResponse"></a>

### ShowWindowResponse
The response of ShowWindow


| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| header | [ResponseHeader](#mcapi-ResponseHeader) |  | Response header |
| body | [ShowWindowResponseBody](#mcapi-ShowWindowResponseBody) |  | Response body |
...
<a name="mcapi-ShowWindowResponseBody"></a>

### ShowWindowResponseBody
The body of ShowWindowResponse
...
| MC_WindowTypeInvalid | 81 | Invalid window Type |
| MC_NoActiveWindowFound | 82 | No active window found |
| MC_WindowNotFound | 83 | Window not found |
| MC_WindowHiddenOrClosed | 84 | Window is hidden or closed |
| MC_WindowClosed | 85 | Window is closed |
| MC_WindowVisible | 86 | Window is visible |
| MC_WindowHidden | 87 | Window is hidden |
...
<a name="mcapi-GetListOfWindowsRequestBody-WindowsFilter"></a>

### GetListOfWindowsRequestBody.WindowsFilter
